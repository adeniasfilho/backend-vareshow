...
module.exports = {
    ...
    readCdstrEstoque: readEstoque, saveEstoque: saveEstoque,
    readCdstrPedido: readPedido, readCdstrPedidoID: readPedidoID,
    saveCdstrPedido: savePedido, deleteCesta: deleteCesta, 
    deleteCliente: deleteCliente,deleteCdstrLojista: deleteLojista, 
    deleteCdstrProduto: deleteProduto,deleteEstoque: deleteEstoque,
    deleteCdstrPedido: deletePedido 
} 
